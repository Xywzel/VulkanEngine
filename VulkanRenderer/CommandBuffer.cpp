...
CommandBuffer::CommandBuffer(VkDevice& device, CommandPool& commandPool, RenderPass& renderPass, Framebuffer& framebuffer, VkExtent2D swapchainExtent, Shader& shader)
{
