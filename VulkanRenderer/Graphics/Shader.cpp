...
void Shader::createPipeline(RenderPass& renderpass)
{
	...
	depthTesting.pNext = nullptr;
	depthTesting.flags = 0;
	depthTesting.depthTestEnable = VK_FALSE;
	...
	pipelineInfo.renderPass = renderpass.getPointer();
